...
- **回归门**：REG-001 首轮未过（缺第 4 条语用边界）→ 回灌修复 + 净室重跑
  **18/18 通过**——回归子集 **10/10** ✓（prior_result 保留可追溯）；
- **引用口径**：对外可引用"外部双盲测 33 案、红线 0、均分 17.88/18、回归 10/10
  （附校准审计）"；self-eval 数字（208/208、17.71）降级为历史参考。
